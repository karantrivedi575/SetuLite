...
import com.paysetu.app.PaySetuApp
import com.paysetu.app.ledger.model.TransactionStatus
import com.paysetu.app.payment.OfflinePaymentEventBus
...
class SmsPaymentReceiver : BroadcastReceiver() {
    ...
    private fun showNotification(context: Context, title: String, message: String) {
        ...
        val launchIntent = try {
            Intent(context, Class.forName("com.paysetu.app.MainActivity")).apply {
        ...
        val notificationBuilder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(R.drawable.ic_dialog_info) // TODO: Change to R.drawable.your_paysetu_logo
